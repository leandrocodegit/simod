            ...
            <div class="card">
                ...
                <div class="flex flex-wrap gap-2">
                    ...
                    <p-popover #op2 id="overlay_panel" [style]="{ width: '450px' }">
                        <p-table responsiveLayout="scroll" [value]="products" selectionMode="single" [(selection)]="selectedProduct" dataKey="id" [rows]="5" [paginator]="true" (onRowSelect)="onProductSelect(op2, $event)">
                            <ng-template #header>
                                <tr>
                                    <th>Name</th>
                                    <th>Image</th>
